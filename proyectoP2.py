...
class ObjetoSeguro:
    ...
    def gen_llaves(self):
        ...
        ''' print("ORIGINAL: ", pubKey)
        print("PEM: ", pubKeyPEM)
        print("TIPO PEM",type(pubKey))
        print("LEN PEM: ", len(pubKeyPEM))
        h1 = RSA.importKey(pubKeyPEM)
        print("CHECAR: ",h1) '''
        ...
        with open("llaves.txt","w") as pk:
            ...
            pk.write(privKeyPEM)
        return pubKeyPEM,keyPair # publica pubKey, privada
    ...
    def cifrar_msj(self,llavePublicaDesinatario, mensaje):
        pubKey = RSA.importKey(llavePublicaDesinatario)
...
# print(Alice.llave_publica())
# temp = Alice.llave_publica()
# print(temp)
# print(type(temp))
